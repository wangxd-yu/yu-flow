...
export class CRUD3CardsPlugin extends BaseCRUDPlugin {
  static id = 'CardsCRUD3Plugin';
  ...
  $schema = '/schemas/AMISCRUD3CardsSchema.json';
  ...
  panelBodyCreator = (context: any) => {
    ...
    this.dynamicControls = {
      /** 列配置 */
      columns: (ctx: any) => this.renderColumnsControl(ctx),
      /** 工具栏配置 */
      toolbar: (ctx: any) => this.renderToolbarCollapse(ctx),
      /** 搜索栏 */
      filters: (ctx: any) => this.renderFiltersCollapse(ctx)
    };
...
registerEditorPlugin(CRUD3CardsPlugin);
