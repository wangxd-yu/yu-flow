...
export class CRUD3TablePlugin extends BaseCRUDPlugin {
  static id = 'TableCRUD3Plugin';
  ...
  $schema = '/schemas/AMISCRUD3TableSchema.json';
...
registerEditorPlugin(CRUD3TablePlugin);
