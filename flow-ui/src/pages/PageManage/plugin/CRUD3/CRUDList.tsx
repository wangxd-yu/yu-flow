...
export class CRUD3ListPlugin extends BaseCRUDPlugin {
  static id = 'ListCRUD3Plugin';
  ...
  $schema = '/schemas/AMISCRUD3ListSchema.json';
...
registerEditorPlugin(CRUD3ListPlugin);
