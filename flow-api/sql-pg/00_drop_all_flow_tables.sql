...
DROP TABLE IF EXISTS flow_log_oss_download CASCADE;
DROP TABLE IF EXISTS flow_log_open_call CASCADE;
DROP TABLE IF EXISTS flow_log_mq_task CASCADE;
...
DROP TABLE IF EXISTS flow_log_alert CASCADE;
DROP TABLE IF EXISTS flow_env CASCADE;
DROP TABLE IF EXISTS flow_directory CASCADE;
DROP TABLE IF EXISTS flow_db_connection CASCADE;
